...
use viv::core::net::tls::key_schedule::{KeySchedule, hkdf_expand_label};
...
fn finished_keys() {
    ...
    let expected_server_fin: [u8; 32] = [
        0x00, 0x8d, 0x3b, 0x66, 0xf8, 0x16, 0xea, 0x55, 0x9f, 0x96, 0xb5, 0x37, 0xe8, 0x85, 0xc3,
        0x1f, 0xc0, 0x68, 0xbf, 0x49, 0x2c, 0x65, 0x2f, 0x01, 0xf2, 0x88, 0xa1, 0xd8, 0xcd, 0xc1,
        0x9f, 0xc8,
    ];
    assert_eq!(
        server_fin, expected_server_fin,
        "server finished key mismatch"
    );

    // RFC 8448 §3 client finished key
    let expected_client_fin: [u8; 32] = [
        0xb8, 0x0a, 0xd0, 0x10, 0x15, 0xfb, 0x2f, 0x0b, 0xd6, 0x5f, 0xf7, 0xd4, 0xda, 0x5d, 0x6b,
        0xf8, 0x3f, 0x84, 0x82, 0x1d, 0x1f, 0x87, 0xfd, 0xc7, 0xd3, 0xc7, 0x5b, 0x5a, 0x7b, 0x42,
        0xd9, 0xc4,
    ];
    assert_eq!(
        client_fin, expected_client_fin,
        "client finished key mismatch"
    );
}
